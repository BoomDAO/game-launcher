...
import { idlFactory } from './game-launcher-staging.did.js';
export { idlFactory } from './game-launcher-staging.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GAME-LAUNCHER-STAGING_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./game-launcher-staging.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the game-launcher-staging canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./game-launcher-staging.did.js")._SERVICE>}
 */
export const game-launcher-staging = createActor(canisterId);
