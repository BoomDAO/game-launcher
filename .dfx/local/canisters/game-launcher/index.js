...
import { idlFactory } from './game-launcher.did.js';
export { idlFactory } from './game-launcher.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GAME-LAUNCHER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./game-launcher.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the game-launcher canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./game-launcher.did.js")._SERVICE>}
 */
export const game-launcher = createActor(canisterId);
