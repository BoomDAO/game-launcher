export const idlFactory = ({ IDL }) => {
  ...
  const Result_5 = IDL.Variant({ ok: MetadataLegacy, err: CommonError });
  ...
  const EXTNFT = IDL.Service({
    ...
    extGetTokenMetadata: IDL.Func([TokenIndex], [IDL.Opt(Metadata)], []),
    ext_addAdmin: IDL.Func([IDL.Principal], [], []),
    ext_addAssetCanister: IDL.Func([], [], []),
    ext_admin: IDL.Func([], [IDL.Vec(IDL.Principal)], ["query"]),
    ...
    ext_getCollectionMetadata: IDL.Func([], [IDL.Text, IDL.Text], []),
    ext_internal_bulk_burn: IDL.Func([IDL.Nat32, IDL.Nat32], [], []),
    ext_internal_burn: IDL.Func([TokenIdentifier__1], [Result_7], []),
    ext_marketplaceList: IDL.Func([ListRequest], [Result_7], []),
    ...
    ext_metadata: IDL.Func([TokenIdentifier__1], [Result_6], ["query"]),
    ext_mint: IDL.Func(
    ...
    ext_removeAdmin: IDL.Func([IDL.Principal], [], []),
    ...
    ext_saleSettle: IDL.Func([AccountIdentifier__1], [Result_3], []),
    ...
    retreive: IDL.Func([AccountIdentifier__1], [Result_3], []),
