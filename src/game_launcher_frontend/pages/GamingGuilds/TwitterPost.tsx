...
const TwitterPost = () => {
    ...
    return (
        <>
            ...
            <p className="font-semibold text-sm pb-4">Click <span className="text-sky-500">Tweet It!</span> button below to share this to twitter or Copy below text as it is and share it on Twitter to get rewarded with BOOM tokens. Your post will be verified in the next 24 hours and rewards will be disbursed.</p>
            <div className="gradient-bg rounded-2xl p-1">
                <div className="bg-white rounded-2xl">
                    <div className="mx-4 px-2 cursor-default font-semibold text-black pt-5" id="post">
                        I joined the BOOM Gaming Guilds and I received 250 BOOM tokens for doing quests in $ICP games!<br></br>
