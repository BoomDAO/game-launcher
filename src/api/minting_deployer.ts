...
// @ts-ignore
import { idlFactory as DeployerFactory } from "../dids/minting_deployer.did.js";
...
// export const useGetCollection = (canisterId?: string): UseQueryResult<Game> =>
//   useQuery({
//     queryKey: [queryKeys.collection, canisterId],
