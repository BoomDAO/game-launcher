...
actor class ICRC1(init : { initial_mints : [{ account : { owner : Principal; subaccount : ?Blob }; amount : Nat }]; minting_account : { owner : Principal; subaccount : ?Blob }; token_name : Text; token_symbol : Text; decimals : Nat8; transfer_fee : Nat }) = this {
// actor class ICRC1() {
//   let init : { initial_mints : [{ account : { owner : Principal; subaccount : ?Blob }; amount : Nat }]; minting_account : { owner : Principal; subaccount : ?Blob }; token_name : Text; token_symbol : Text; decimals : Nat8; transfer_fee : Nat } =
//   { 
//     initial_mints = [{account = {owner = Principal.fromText("q45vb-lcydd-emkdj-wgdhi-czsod-imrcm-bv3ze-mkxm6-sd2ox-y5zou-tqe");subaccount = null;};amount = 100000000000000000;}];
//     minting_account = {owner = Principal.fromText("q45vb-lcydd-emkdj-wgdhi-czsod-imrcm-bv3ze-mkxm6-sd2ox-y5zou-tqe");subaccount = null;};
