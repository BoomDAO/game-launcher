...
module {
    ...
    public type ICP = actor {
        account_balance : shared query ICP.BinaryAccountBalanceArgs -> async ICP.Tokens;
        ...
        transfer_fee : shared query {} -> async ICP.TransferFee;
    };
    ...
    public type ICRC1 = actor {
        ...
        icrc1_transfer : (ICRC1.TransferArg) -> async (ICRC1.TransferResult);
